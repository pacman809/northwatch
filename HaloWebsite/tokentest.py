...
def balanceInfo(personal_address):
    ...
    #personal_address = input("Enter Address")
    ...
    for i in contract_address:
        ...
        #balance = format(balance,'f').rstrip('0').rstrip('.')
    ...
    #results.update( {"Masternodes" : data_results} )
    return results

#https://mn-api.haloplatform.tech/owned/

add = "0x01a16f3b3ec715a465bdba6715023e6120def236"

print(balanceInfo(add))